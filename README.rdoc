...
of the configuration options. This dependency has been removed, and therefore
...
An update can of the existing remote partials can be triggered by running the
following rake task:
